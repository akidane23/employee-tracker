...
class Query {
    ...
    addRole = function getRoleInfo(main) {
        ...
        },
        {
            ...
            // choices: [1,2,3] //some async function that returns an array of choices
            // in a future version would make the array opulate with available departments from database but hard coded this time
        }
        ])
